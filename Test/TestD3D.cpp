...
void InitGraphics() {
	VERTEX OurVertices[] = {
		{XMFLOAT3(0.0f, 0.5, 0.0f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f)},
...
HRESULT CreateGrapshicsResources(HWND hWnd) {
	HRESULT hr = S_OK;
...
LRESULT WindowProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	case WM_CREATE:
		...
		break;
	case WM_PAINT:
		result = CreateGrapshicsResources(hWnd);
		RenderFrame();
		wasHandled = true;
		break;
	case WM_SIZE:
